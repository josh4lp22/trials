...
class Employee
{
	...
	function insertEmployee($usr,$pass,$name,$sex,$dob,$phone,$email,$net,$c,$java,$swt)
	{
		...
		$sql="SELECT * FROM employee2 where usrName='" .$usr. "'";
		...
		if($num_rows >0)
		{
			...
			echo "<BR><A href='Validation.html'> Home </A>";
			exit;
		}
		else
		{
...
$empObj->insertEmployee($_POST['txtUsrname'],$_POST['txtPassword'],$_POST['txtName'],$_POST['rdSex'],$_POST['txtDate'],$_POST['txtPhone'],$_POST['txtEmail'],$_POST['chkDotNet'],$_POST['chkCLang'],$_POST['chkJava'],$_POST['chkSwt']);

?>
<BR><A href="Validation.html"> Home </A>